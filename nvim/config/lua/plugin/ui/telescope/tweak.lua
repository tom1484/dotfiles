...
local tab_drop = function(prompt_bufnr)
    ...
    local buf_infos = utils.buffer_infos()
    local buf_info = buf_infos[entry_bufnr]
    local active = buf_info ~= nil and buf_info.active
