return {
    setup = function()
        local highlight_utils = require("utils.highlight")
        ...
        local set_highlights = highlight_utils.set_highlights
        local update_highlights = highlight_utils.update_highlights
        local set_highlights_pattern = function(pattern, opts)
            local result = table_utils.match_words(highlight_names, pattern)
        ...
        --- Separators
        --------------------
        set_highlights("WinSeparator", { fg = "#666666" })
        ...
        update_highlights("SignColumn", { bg = "none" })

        --------------------
        --- Incline
        --------------------
        set_highlights({ "InclineNormal", "InclineNormalNC" }, { fg = "#C8C093" })
        ...
        update_highlights("BlinkCmpMenuBorder", { bg = "none" })
    end,
}
